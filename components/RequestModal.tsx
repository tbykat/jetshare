        ...
        {confirmed ? (
          ...
          <div className="p-8 text-center">
            ...
            <h2 className="text-xl font-bold text-slate-900 mb-1">
              {confirmed.seats_reserved === 1 ? '1 seat reserved!' : `${confirmed.seats_reserved} seats reserved!`}
            </h2>
            <p className="text-slate-500 text-sm mb-6">
              Contact <span className="font-medium text-slate-700">{confirmed.owner_name}</span> to confirm the details and arrange your seat.
            </p>
            ...
            <div className="bg-slate-50 rounded-xl p-4 text-left space-y-2 mb-4">
              ...
              <p className="text-slate-500 text-sm">{confirmed.departure_fbo} → {confirmed.arrival_fbo}</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              {flight.cost_per_seat != null && flight.cost_per_seat > 0 && (
                <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 text-sm text-amber-800">
                  <span className="font-semibold">${flight.cost_per_seat.toLocaleString()} per seat</span> — arrange payment directly with the owner.
                </div>
              )}
